...
public class PublicChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(String message) {
        ...
        AndroidNetworking.post(url)
                ...
                .addBodyParameter("is_private", String.valueOf(Constants.PUBLIC_MESSAGE))
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(PublicChatActivity.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
    ...
    private void getAllMessages() {
        ...
        String url = Urls.BASE_URL + Urls.GET_PUBLIC_CHAT_MESSAGES;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            messagesAdapter = new ChatMessagesAdapter(messages, PublicChatActivity.this);
                    ...
                    public void onError(ANError error) {
                        // handle error
                        pDialog.dismiss();
                        Toast.makeText(PublicChatActivity.this, error.getErrorBody(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}