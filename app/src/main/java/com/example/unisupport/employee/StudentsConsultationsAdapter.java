...
public class StudentsConsultationsAdapter extends RecyclerView.Adapter<StudentsConsultationsAdapter.ViewHolder> {

    Context context;
    private List<StudentConsultation> items;
    private int status;

    // RecyclerView recyclerView;
    public StudentsConsultationsAdapter(Context context, ArrayList<StudentConsultation> items, int status) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        StudentConsultation item = items.get(position);
        ...
        holder.itemView.setOnClickListener(v -> {
            if(status == Constants.ANSWERED){
                ...
                intent.putExtra("consultation", item.getQuestion());
