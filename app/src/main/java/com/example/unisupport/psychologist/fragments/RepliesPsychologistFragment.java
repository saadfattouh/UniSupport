...
public class RepliesPsychologistFragment extends Fragment {
    ...
    public RepliesPsychologistFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_replies_psychologist, container, false);
    }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                                     ...
                                     public void onResponse(JSONObject response) {
                                         ...
                                         try {
                                             ...
                                             mAdapter = new StudentsQuestionsAdapter(context, replies, Constants.ANSWERED);
